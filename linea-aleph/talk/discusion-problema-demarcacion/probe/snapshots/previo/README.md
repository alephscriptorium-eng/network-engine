...
- **URL:** https://es.wikipedia.org/w/index.php?title=Discusión:Problema_de_la_demarcación&oldid=0

El cuerpo del artículo **no** vive aquí en markdown. Tras `fetch_snapshot.py`:

```
cache/snapshots/0.wikitext   # fuente
cache/snapshots/0.meta.json  # metadatos de fetch
```
