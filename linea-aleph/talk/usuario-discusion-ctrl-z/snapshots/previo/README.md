...
- **URL:** https://es.wikipedia.org/w/index.php?title=Usuario_discusión:Ctrl_Z&oldid=11683339

El cuerpo del artículo **no** vive aquí en markdown. Tras `fetch_snapshot.py`:

```
cache/snapshots/11683339.wikitext   # fuente
cache/snapshots/11683339.meta.json  # metadatos de fetch
```
