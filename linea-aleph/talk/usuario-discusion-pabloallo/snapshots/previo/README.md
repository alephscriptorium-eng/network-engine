...
- **URL:** https://es.wikipedia.org/w/index.php?title=Usuario_discusión:Pabloallo&oldid=11420206

El cuerpo del artículo **no** vive aquí en markdown. Tras `fetch_snapshot.py`:

```
cache/snapshots/11420206.wikitext   # fuente
cache/snapshots/11420206.meta.json  # metadatos de fetch
```
