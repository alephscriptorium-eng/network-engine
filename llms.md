...
```
engines/ logs-aleph/ sima-aleph/ cima-aleph/ linea-aleph/ lineas-poder/ logs-skill/  # corpus in situ
...
- Líneas de poder: `agents/skills/lineas-poder-browser/SKILL.md` · catálogo `lineas-poder/` (instancia v0: `espana`)
